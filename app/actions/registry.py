...
APP_ACTIONS: tuple[ActionSpec, ...] = (
    ...
    ActionSpec("routines.list",         "routines", READ,        "List routines and read their runs"),
    ActionSpec("routines.create",       "routines", WRITE,       "Create a routine"),
    ActionSpec("routines.update",       "routines", WRITE,       "Change or switch off a routine"),
    ActionSpec("routines.delete",       "routines", DESTRUCTIVE, "Delete a routine"),
    ActionSpec("routines.run",          "routines", WRITE,       "Run a routine now"),
    ActionSpec("notifications.send",    "notifications", WRITE,  "Send a notification from a routine"),
    ActionSpec("reports.list",          "reports",  READ,        "List reports and read what they produced"),
    ActionSpec("reports.create",        "reports",  WRITE,       "Create a report"),
    ActionSpec("reports.update",        "reports",  WRITE,       "Change or switch off a report"),
    ActionSpec("reports.delete",        "reports",  DESTRUCTIVE, "Delete a report and everything it produced"),
    ActionSpec("reports.run",           "reports",  WRITE,       "Produce a report now"),
    ActionSpec("reports.download",      "reports",  READ,        "Download a report as PDF or CSV"),
    ActionSpec("tokens.list",           "tokens",   READ,        "List your API tokens (an administrator sees everyone's)"),
    ActionSpec("tokens.create",         "tokens",   WRITE,       "Make an API token for an outside AI tool"),
    ActionSpec("tokens.revoke",         "tokens",   WRITE,       "Revoke an API token"),
    ActionSpec("mcp.use",               "tokens",   READ,        "Reach NASQuay from an outside AI tool over MCP"),
